...
public class CadastroPremiacao extends javax.swing.JDialog {
    ...
    private Premiacoes premiacoes;

    public Premiacoes getPremiacoes() {
        return premiacoes;
    }
...
private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
    ...
    premiacoes = new Premiacoes(jTextFieldPremiacao.getText(), Integer.parseInt(jTextFieldAno.getText()));
